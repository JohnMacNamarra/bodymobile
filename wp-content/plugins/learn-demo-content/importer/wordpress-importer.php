 ...
 * Modified from the WP Importer plugin.
 * This version of importer is allowed to import all menu item's meta.
 *
 ...
 */
if ( class_exists( 'WP_Importer' ) ) {
class TA_Content_Importer extends WP_Importer {
	...
	function TA_Content_Importer() { /* nothing */ }
	...
	function process_menu_item( $item ) {
		...
		if ( $id && ! is_wp_error( $id ) ) {
			...
			foreach ( $args as $key => $value ) {
				unset( $menu_item_meta['_' . str_replace( '-', '_', $key )] );
			}
