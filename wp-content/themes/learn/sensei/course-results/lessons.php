        ...
        if( 0 < count( $lessons ) ): ?>
            ...
            <?php foreach ( $lessons as $lesson ): ?>
                ...
                <h2>
                    ...
                    <a href="<?php echo esc_url_raw( get_permalink( $lesson->ID ) ) ?>" title="<?php esc_attr_e( sprintf( __( 'Start %s', 'learn' ), $lesson->post_title ) ) ?>" >

                        <?php esc_html_e( sprintf( __( '%s', 'learn' ), $lesson->post_title ) ); ?>
